...
export default function CreateServicePage() {
  ...
  const watchedServiceTitle = watch('serviceTitle');
  ...
  const isFormReady = watchedCardTitle?.trim() && 
                     ...
                     watchedServiceDescription?.trim() && 
                     cardImage && 
                     heroImage;
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      formData.append('blogTitle', data.serviceTitle);
      formData.append('blogDescription', data.serviceDescription);
  ...
  return (
    <DashboardLayout title="Create Service" subtitle="Add a new dental service">
      <div ref={containerRef} className="max-w-4xl mx-auto">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          {/* Card Information */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Service Card Information</h3>
          ...
          {/* Service Blog Information */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Service Blog Information</h3>
